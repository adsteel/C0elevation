...
# RSpec.describe "trip_costs/edit", :type => :view do
#   before(:each) do
#     @trip_cost = assign(:trip_cost, TripCost.create!(
#       :trip_id => 1,
#       :one => 1,
#       :two => 1,
#       :three => 1,
...
#   it "renders the edit trip_cost form" do
#     render

#     assert_select "form[action=?][method=?]", trip_cost_path(@trip_cost), "post" do
